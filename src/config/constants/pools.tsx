...
export const vaultPoolConfig = {
  [VaultKey.CakeVaultV1]: {
    ...
    gasLimit: 380000,
    tokenImage: {
      primarySrc: `/images/tokens/${bscTokens.irs.address}.svg`,
      secondarySrc: '/images/tokens/autorenew.svg',
    },
  },
  [VaultKey.CakeVault]: {
    name: <Trans>Stake RBL</Trans>,
  ...
  [VaultKey.IfoPool]: {
    name: 'IFO RBL',
    description: <Trans>Stake RBL to participate in IFOs</Trans>,
...
export const livePools: SerializedPoolConfig[] = [
  {
    sousId: 0,
    stakingToken: bscTokens.irs,
    earningToken: bscTokens.irs,
    contractAddress: {
