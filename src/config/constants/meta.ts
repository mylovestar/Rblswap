...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for Utils exchanges.' },
      '/info/pools': { title: t('Pools'), description: 'View statistics for Utils exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for Utils exchanges.' },
