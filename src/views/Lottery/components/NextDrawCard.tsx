...
import { Card, CardHeader, CardBody, Skeleton, useModal, Box, CardFooter, ExpandableLabel } from '@pancakeswap/uikit'
...
const NextDrawCard = () => {
  ...
  const getPrizeBalances = () => {
    if (status === LotteryStatus.CLOSE || status === LotteryStatus.CLAIMABLE) {
      return (
        <Heading color="#fff" textAlign={['center', null, null, 'left']}>
          {t('Calculating')}...
        </Heading>
      )
    }
  ...
  return (
    <StyledCard>
      <CardHeader p="16px 24px" style={{ background: '#12161c', borderBottom: '1px solid #FFFFFF18' }}>
        <Flex justifyContent="space-between">
          <Heading fontSize="26px" fontWeight="800" textTransform="uppercase" mr="12px">
            {t('Next Draw')}
          </Heading>
          <Text>
      ...
      <CardBody style={{ background: '#12161c' }}>
        <Grid>
          <Flex justifyContent={['center', null, null, 'flex-start']}>
            <Heading>{t('Prize Pot')}</Heading>
          </Flex>
          <Flex flexDirection="column" alignItems="center" mb="18px">
            {getPrizeBalances()}
          </Flex>
          ...
          <Flex flexDirection={['column', null, null, 'row']} alignItems={['center', null, null, 'center']}>
            ...
            <Flex justifyContent="center" w="100%">
              <BuyTicketsButton
                style={{ background: '#fff', color: '#3ddcc8', width: '213px', textTransform: 'uppercase' }}
      ...
      <CardFooter p="0" style={{ background: '#12161c', borderTop: '1px solid #FFFFFF18' }}>
        {isExpanded && (
          <NextDrawWrapper>
